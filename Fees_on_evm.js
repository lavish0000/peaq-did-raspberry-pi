...
const endpointBlock = 'http://127.0.0.1:8080/blocks/2472648';
...
async function main() {
  try {
    ...
    responseBlock.data.extrinsics.forEach((extrinsic) => {
      ...
      console.log("extrinsic.args.transaction", extrinsic.args.transaction?.eip1559);
